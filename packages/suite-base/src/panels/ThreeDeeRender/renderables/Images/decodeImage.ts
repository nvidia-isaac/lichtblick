...
export function isVideoKeyframe(frameMsg: CompressedImageTypes): boolean {
...
export function getVideoDecoderConfig(frameMsg: CompressedImageTypes): VideoDecoderConfig | undefined {
  switch (frameMsg.format) {
    case "h264": {
